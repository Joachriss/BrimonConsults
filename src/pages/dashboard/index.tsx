  ...
  return (
    <section className="p-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4">
        ...
        <Link to="/admin/projects" className="rounded-lg col-span-full sm:col-span-6 md:col-span-4 shadow bg-white hover:scale-[103%] duration-300 w-full py-4 px-8 gap-4 font-bold flex flex-row items-center justify-between">
          <div className="flex flex-col gap-3">
        ...
        <Link to="/admin/faqs" className="rounded-lg col-span-full sm:col-span-6 md:col-span-4 shadow bg-white hover:scale-[103%] duration-300 w-full py-4 px-8 gap-4 font-bold flex flex-row items-center justify-between">
          <div className="flex flex-col gap-3">

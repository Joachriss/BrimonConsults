...
export const CompanyPage = () => {
  ...
  return (
    <section className="w-full bg-white dark:bg-gray-900">
      <PageHeader pageName="Who We Are" recall="Our company" services={["Our Vision", "Our Mission", "Our Values","Certifications & Licenses"]} image="bg-[url('/projects/Proposed-Presidential-Library/image2.webp')]" />

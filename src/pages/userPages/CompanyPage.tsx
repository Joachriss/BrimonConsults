...
export const CompanyPage = ({title}:{title:string}) => {
  ...
  return (
    <section className="w-full bg-white dark:bg-gray-900">
      <PageHeader pageName="Who We Are" recall="Our company" services={["Our Vision", "Our Mission", "Our Values","Our Policies", "Certifications & Licenses"]} image="bg-[url('/projects100/Iyumbu/image3.webp')]" />

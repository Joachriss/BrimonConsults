...
import { HowWeWork } from "./fragments/HowWeWork"
import { ProjectsSection } from "./fragments/ProjectsSection"
import { ServicesSection } from "./fragments/ServicesSection"
...
export const Home = () => {
    ...
    return (
        <div>
            ...
            <section className="bg-gray-50 spacing-y-5 dark:bg-gray-800">

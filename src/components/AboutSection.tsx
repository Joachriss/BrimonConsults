            ...
            <div
                ...
                <div className="col-span-2 space-y-8 md:grid sm:grid-cols-2 md:gap-12 md:space-y-0">
                    ...
                    <div>
                        ...
                        <h3 className="mb-2 text-2xl font-bold dark:text-white flex flex-row"><Counter total={10} />+ Projects</h3>
                    ...
                    <div>
                        ...
                        <h3 className="mb-2 text-2xl font-bold dark:text-white flex flex-row"><Counter total={10} />+ Happy clients</h3>
                        <p className="font-light text-gray-500 dark:text-gray-400">
                    ...
                    <div>
                        ...
                        <h3 className="mb-2 text-2xl font-bold dark:text-white">Quantity Surveying</h3>
                        <p className="font-light text-gray-500 dark:text-gray-400">

...
export const ContactUs = () => {
    ...
    return (
        <div className={`${isScrolled ? "sm:flex flex-col hidden " : "hidden"} fixed  space-y-7 bg-white bottom-10 md:bottom-[40%] cursor-pointer left-3 z-50 py-4 px-2 rounded-2xl shadow-lg `}>
